...
class ModifierInformationGenerale extends AppModel {
    ...
    function verifierAssuranceMaladie($champ) {
        $naissance = $this->data['ModifierInformationGenerale'];
    ...
    function verifierTuteur($field) {
        ...
        if (!empty($field[$s])) {
            ...
            foreach ($listeChamp as $champ) {
                if (!empty($this->data['ModifierInformationGenerale'][$champ])) {
                    return false;
                }
            }
        }

        if ($s == 'sexe_tuteur' && !empty($this->data['ModifierInformationGenerale']['sexe_tuteur'])) {
            return false;
        }
