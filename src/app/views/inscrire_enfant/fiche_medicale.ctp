<?php 
	...
	echo '<h2>' .__('Antécédents médicaux',true). '</h2>';
	$num  = 7;
	...
	echo '</td></tr></table></br>';
	echo '<h2>'. __('Question générales sur votre jeune',true). '</h2>';
	$tab = array();
	$tab[] = 'question 1';
	$tab[] = 'question 2';
	...
	echo '</table>';
	echo '<table><tr><td><h2>'. __('Médicament(s) autorisé(s)',true). '<h2></td></tr>';//<td><h2>'.__('Médicament(s) sous prescription avec posologie ',true). '</h2></td></tr>';
