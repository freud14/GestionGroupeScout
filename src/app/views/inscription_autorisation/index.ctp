...
$tab = array();
$tab[] = 'Moi, '. $parent . ', accepte que '. $this->Session->read('info_gen.InformationGenerale.prenom') . ' ' . $this->Session->read('info_gen.InformationGenerale.nom').' se baigne sous la surveillance des animateurs du 102e Groupe scout des Laurentides.';
...
$tab[] = 'Moi, '. $parent . ', accepte que 102e Groupe scout des Laurentides et le District de Québec publient des photos anonymes de  '. $this->Session->read('info_gen.InformationGenerale.prenom'). ' ' . $this->Session->read('info_gen.InformationGenerale.nom') .' dans le but de faire la promotion du scoutisme.';
