...
$tab = array();
$tab[] = 'Moi, '. $parent . ', accepte que '. $this->Session->read('info_gen.InformationGenerale.prenom') .' se baigne sous la surveillance des animateurs du 102e Groupe scout des Laurentildes.';
...
$tab[] = 'Moi, '. $parent . ', accepte que 102e Groupe scout des Laurentildes et le District de Québec publient des photos anonymes de  '. $this->Session->read('info_gen.InformationGenerale.prenom') .' dans le but de faire la promotion du scoutisme.';
