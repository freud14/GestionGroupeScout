		...
		<div id="header">
			<div class="menu">
				<ul>
					...
					<li><?php echo $this->Html->link(__('Administration', true), array("controller" => "accueil", "action" => "admin")); ?></li>
							...
							<ul>
								...
								<li>
									...
									<ul>
										...
										<li><?php echo $this->Html->link(__('Animateur', true), array("controller" => "liste_unite", "action" => "assigner_animateur")); ?></li>
									</ul>
								</li>
							</ul>
						</li>
					...
					<li style="float:right;"><?php echo $this->Html->link(__('Déconnexion', true), array("controller" => "deconnexion", "action" => "index")); ?></li>
				</ul>
			</div>
