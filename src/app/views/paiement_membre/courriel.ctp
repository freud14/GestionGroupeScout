...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	<head>
		...
		<?php if (isset($rapport['Adulte']['prenom'])) { ?>
			<title><?php echo __('Reçu aux fins d\'impôt de ', true) . $rapport['Adulte']['prenom'] . " " . $rapport['Adulte']['nom']; ?> - 102e Groupe scout des Laurentides</title>
		<?php } else { ?>
			<title><?php echo __('Reçu aux fins d\'impôt de ', true) . $rapport[0][0]['adulte_nom']; ?> - 102e Groupe scout des Laurentides</title>
		<?php } ?>
	</head>
	<body>
		<?php
